...
RUN mkdir /usr/local/www/aria2/Download && cd /usr/local/www/aria2 \
 ...
 && wget -N --no-check-certificate https://github.com/mayswind/AriaNg/releases/download/0.4.0/aria-ng-0.4.0.zip && unzip aria-ng-0.3.0.zip && rm -rf aria-ng-0.3.0.zip \
